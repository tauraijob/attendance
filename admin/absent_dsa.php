...
<html lang = "eng">
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right">School Management System</p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="#"> Python Absent: &nbsp </a>
				<a href="absent_cf.php" style="margin-right:20px; color:red;">Monday</a>
				<a href="absent_cs.php" style="margin-right:20px;">Tuesday</a>
				<a href="absent_csa.php" style="margin-right:20px;">Wednesday</a>
                <a href="absent_csa.php" style="margin-right:20px;">Thursday</a>
                <a href="absent_csa.php" style="margin-right:20px;">Friday</a>
			<a href="absent_cf.php" style="float:right;">Go To FrontEnd Absent Page?</a></div>
	...
	<div class = "well col-lg-12">
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$q_student = $conn->query("SELECT * FROM `calen_monday`") or die(mysqli_error());
							...
							while($f_time1=$list1->fetch_array())
									{
							if($f_time1['track']=="Python"){
									if($f_time1['schedule']=='Monday AM' || $f_time1['schedule']=='Monday PM' ){
		...
		$(document).ready(function(){
			$('.rlate_id').click(function(){
				...
				$('.remove_id').click(function(){
					window.location = 'delete_frontend.php?late_id=' + $late_id;
				});
			});
		});
	</script>
