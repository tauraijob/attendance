...
<html lang = "eng">
	<head>
		<title>Muzinda |Wednesday Schedule</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="cal_s.php">Tuesday</a>
			<a href="cal_su.php" style="color:red;">Wednesday</a>
			<a href="cal_su.php">Thursday</a>
			<a href="cal_su.php">Friday</a>
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$q_admin = $conn->query("SELECT * FROM `calen_wednesday`") or die(mysqli_error());
