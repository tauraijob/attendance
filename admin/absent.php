...
<html lang = "eng">
	...
	<body>
		...
		<div class = "well col-lg-12">
			<br />
			<h2><a style="text-decoration:none;" href = "absent_frontend.php"><span class = "glyphicon glyphicon-user"></span> Absent From FrontEnd</a></h2>
			<br />
			<br />	
			<h2><a style="text-decoration:none;" href = "absent_python.php"><span class = "glyphicon glyphicon-user"></span> Absent From Python</a></h2>
			<br />
			</div>
		</div>
		<br>	<br>	<br>	<br>
