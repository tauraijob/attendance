...
<html lang = "eng">
	<head>
		<title>MuzindaHub | Add Student</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="calendar.php" style="color:red;">Monday</a>
			<a href="cal_tuesday.php">Tuesday</a>
			<a href="cal_monday.php">Wednesday</a>
			<a href="cal_monday.php">Thursday</a>
			<a href="cal_tuesday.php">Friday</a>
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$q_admin = $conn->query("SELECT * FROM `calen_monday`") or die(mysqli_error());
