...
<html lang = "eng">
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="#"> FrontEnd Absent: &nbsp </a>
				...
				<a href="absent_wednesday.php" style="margin-right:20px;color:red;">Wednesday</a>
	...
	<div class = "well col-lg-12">
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$q_student = $conn->query("SELECT * FROM `calen_wednesday`") or die(mysqli_error());
							...
							if($f_time1['track']=="Python"){
									if($f_time1['schedule']=='Wednesday AM' || $f_time1['schedule']=='Wednesday PM' ){
