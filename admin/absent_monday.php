			...
			<ul class = "nav nav-pills">
				...
				<li class = "dropdown active">
					...
					<ul class = "dropdown-menu">
						...
						<li><a href = "d201.php"><span class = "glyphicon glyphicon-user"></span>Python</a></li>
					</ul>
				</li>
				<li><a href = "barcode/html/BCGcode39.php"><span class = "glyphicon glyphicon-barcode"></span> Barcode</a></li>
				
				<li><a href = "../index.php"><span class = "glyphicon glyphicon-eye-open" ></span> Barcode Scanner</a></li>
			</ul>
			<br />
			<div class = "alert alert-info">
			<a href="#"> Front End Absent: &nbsp </a>
				<a href="absent_monday.php" style="margin-right:20px; color:red;">Monday</a>
				<a href="absent_tuesday.php" style="margin-right:20px;">Tuesday</a>
	...
	<div class = "well col-lg-12">
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid" style="margin-top:15px;">
				<label class = "pull-left">&copy; Muzinda <?php echo date("Y");?></label>
			</div>	
		</div>	
	</body>
