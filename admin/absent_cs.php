	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="#"> Front End Absent: &nbsp </a>
				<a href="absent_cf.php" style="margin-right:20px;" >Monday</a>
				<a href="absent_cs.php" style="margin-right:20px; color:red;">Tuesday</a>
			...
			<a href="absent_df.php" style="float:right;">Go To Python Absent Page?</a></div>
