...
<html lang = "eng">
	<head>
		<title>Muzinda| FWED Records</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				...
				<li class = "dropdown active">
					...
					<ul class = "dropdown-menu">
						...
						<li><a href = "frontend.php"><span class = "glyphicon glyphicon-user"></span>Front End</a></li>
			...
			<br />
			<div class = "alert alert-info">FrontEnd Student Record</div>
				...
				<table id = "table" class = "table table-bordered">
					...
					?>	
						<tr>
							...
							href = "frontend.php?idx=<?php echo $f_time['late_id']?>">
